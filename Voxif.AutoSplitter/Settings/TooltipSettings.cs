...
namespace Voxif.AutoSplitter {
    public partial class TooltipSettings : UserControl {
        ...
        public void SetText(string value) {
            int height = (value.Length - value.Replace("\n", String.Empty).Length + 1) * 15 + 10;
            TableLayoutPanel.RowStyles[0].Height = height;
        ...
        public void SetImage(Bitmap bmp, int index = 0) {
            if(bmp != null) {
                ...
                && TableLayoutPanel.Width <= TableLayoutPanel.ColumnStyles[1].Width + 1) {
                    ...
                    if(PictureBox.Margin.Bottom != 5) {
                        PictureBox.Margin = new Padding(0, 0, 0, 5);
                    }
                }
            } else {
